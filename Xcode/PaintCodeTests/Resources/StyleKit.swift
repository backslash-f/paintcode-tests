...
public class StyleKit : NSObject {
    ...
    @objc dynamic public class func drawCircleShape(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, angle: CGFloat = 0) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
