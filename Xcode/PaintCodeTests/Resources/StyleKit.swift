...
public class StyleKit : NSObject {
    ...
    @objc dynamic public class func drawClockHand(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 200), resizing: ResizingBehavior = .aspectFit, rotation: CGFloat = 388) {
    ...
    @objc dynamic public class func drawWatchButton(frame: CGRect = CGRect(x: 8, y: 8, width: 38, height: 38), highlighted: Bool = false) {
        //// General Declarations
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }

        //// Color Declarations
        let blueish = UIColor(red: 0.173, green: 0.224, blue: 0.259, alpha: 1.000)
        let blueish50 = UIColor(red: 0.173, green: 0.224, blue: 0.259, alpha: 0.500)

        //// Variable Declarations
        let isHighlighted = highlighted ? false : true


        //// Subframes
        let watchGroup: CGRect = CGRect(x: frame.minX + fastFloor(frame.width * 0.02632 + 0.5), y: frame.minY + fastFloor(frame.height * 0.02632 + 0.5), width: fastFloor(frame.width * 0.97368 + 0.5) - fastFloor(frame.width * 0.02632 + 0.5), height: fastFloor(frame.height * 0.97368 + 0.5) - fastFloor(frame.height * 0.02632 + 0.5))


        //// WatchGroup
        //// WatchShapePressed Drawing
        let watchShapePressedPath = UIBezierPath()
        watchShapePressedPath.move(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.00000 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.00000 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.22431 * watchGroup.width, y: watchGroup.minY + 0.00000 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.00000 * watchGroup.width, y: watchGroup.minY + 0.22431 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 1.00000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.00000 * watchGroup.width, y: watchGroup.minY + 0.77569 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.22431 * watchGroup.width, y: watchGroup.minY + 1.00000 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 1.00000 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.77569 * watchGroup.width, y: watchGroup.minY + 1.00000 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 1.00000 * watchGroup.width, y: watchGroup.minY + 0.77569 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.00000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 1.00000 * watchGroup.width, y: watchGroup.minY + 0.22431 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.77569 * watchGroup.width, y: watchGroup.minY + 0.00000 * watchGroup.height))
        watchShapePressedPath.close()
        watchShapePressedPath.move(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.91667 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.08333 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.26992 * watchGroup.width, y: watchGroup.minY + 0.91667 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.08333 * watchGroup.width, y: watchGroup.minY + 0.73008 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.08333 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.08333 * watchGroup.width, y: watchGroup.minY + 0.26992 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.26992 * watchGroup.width, y: watchGroup.minY + 0.08333 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.91667 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.73011 * watchGroup.width, y: watchGroup.minY + 0.08333 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.91667 * watchGroup.width, y: watchGroup.minY + 0.26992 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.91667 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.91667 * watchGroup.width, y: watchGroup.minY + 0.73008 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.73011 * watchGroup.width, y: watchGroup.minY + 0.91667 * watchGroup.height))
        watchShapePressedPath.close()
        watchShapePressedPath.move(to: CGPoint(x: watchGroup.minX + 0.80556 * watchGroup.width, y: watchGroup.minY + 0.44444 * watchGroup.height))
        watchShapePressedPath.addLine(to: CGPoint(x: watchGroup.minX + 0.55556 * watchGroup.width, y: watchGroup.minY + 0.44444 * watchGroup.height))
        watchShapePressedPath.addLine(to: CGPoint(x: watchGroup.minX + 0.55556 * watchGroup.width, y: watchGroup.minY + 0.19444 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.13889 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.55556 * watchGroup.width, y: watchGroup.minY + 0.16375 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.53069 * watchGroup.width, y: watchGroup.minY + 0.13889 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.44444 * watchGroup.width, y: watchGroup.minY + 0.19444 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.46931 * watchGroup.width, y: watchGroup.minY + 0.13889 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.44444 * watchGroup.width, y: watchGroup.minY + 0.16375 * watchGroup.height))
        watchShapePressedPath.addLine(to: CGPoint(x: watchGroup.minX + 0.44444 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.55556 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.44444 * watchGroup.width, y: watchGroup.minY + 0.53067 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.46931 * watchGroup.width, y: watchGroup.minY + 0.55556 * watchGroup.height))
        watchShapePressedPath.addLine(to: CGPoint(x: watchGroup.minX + 0.80556 * watchGroup.width, y: watchGroup.minY + 0.55556 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.86111 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.83625 * watchGroup.width, y: watchGroup.minY + 0.55556 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.86111 * watchGroup.width, y: watchGroup.minY + 0.53067 * watchGroup.height))
        watchShapePressedPath.addCurve(to: CGPoint(x: watchGroup.minX + 0.80556 * watchGroup.width, y: watchGroup.minY + 0.44444 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.86111 * watchGroup.width, y: watchGroup.minY + 0.46933 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.83625 * watchGroup.width, y: watchGroup.minY + 0.44444 * watchGroup.height))
        watchShapePressedPath.close()
        blueish50.setFill()
        watchShapePressedPath.fill()


        if (isHighlighted) {
            //// WatchShape Drawing
            let watchShapePath = UIBezierPath()
            watchShapePath.move(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.00000 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.00000 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.22431 * watchGroup.width, y: watchGroup.minY + 0.00000 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.00000 * watchGroup.width, y: watchGroup.minY + 0.22431 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 1.00000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.00000 * watchGroup.width, y: watchGroup.minY + 0.77569 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.22431 * watchGroup.width, y: watchGroup.minY + 1.00000 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 1.00000 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.77569 * watchGroup.width, y: watchGroup.minY + 1.00000 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 1.00000 * watchGroup.width, y: watchGroup.minY + 0.77569 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.00000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 1.00000 * watchGroup.width, y: watchGroup.minY + 0.22431 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.77569 * watchGroup.width, y: watchGroup.minY + 0.00000 * watchGroup.height))
            watchShapePath.close()
            watchShapePath.move(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.91667 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.08333 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.26992 * watchGroup.width, y: watchGroup.minY + 0.91667 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.08333 * watchGroup.width, y: watchGroup.minY + 0.73008 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.08333 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.08333 * watchGroup.width, y: watchGroup.minY + 0.26992 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.26992 * watchGroup.width, y: watchGroup.minY + 0.08333 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.91667 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.73011 * watchGroup.width, y: watchGroup.minY + 0.08333 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.91667 * watchGroup.width, y: watchGroup.minY + 0.26992 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.91667 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.91667 * watchGroup.width, y: watchGroup.minY + 0.73008 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.73011 * watchGroup.width, y: watchGroup.minY + 0.91667 * watchGroup.height))
            watchShapePath.close()
            watchShapePath.move(to: CGPoint(x: watchGroup.minX + 0.80556 * watchGroup.width, y: watchGroup.minY + 0.44444 * watchGroup.height))
            watchShapePath.addLine(to: CGPoint(x: watchGroup.minX + 0.55556 * watchGroup.width, y: watchGroup.minY + 0.44444 * watchGroup.height))
            watchShapePath.addLine(to: CGPoint(x: watchGroup.minX + 0.55556 * watchGroup.width, y: watchGroup.minY + 0.19444 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.13889 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.55556 * watchGroup.width, y: watchGroup.minY + 0.16375 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.53069 * watchGroup.width, y: watchGroup.minY + 0.13889 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.44444 * watchGroup.width, y: watchGroup.minY + 0.19444 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.46931 * watchGroup.width, y: watchGroup.minY + 0.13889 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.44444 * watchGroup.width, y: watchGroup.minY + 0.16375 * watchGroup.height))
            watchShapePath.addLine(to: CGPoint(x: watchGroup.minX + 0.44444 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.50000 * watchGroup.width, y: watchGroup.minY + 0.55556 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.44444 * watchGroup.width, y: watchGroup.minY + 0.53067 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.46931 * watchGroup.width, y: watchGroup.minY + 0.55556 * watchGroup.height))
            watchShapePath.addLine(to: CGPoint(x: watchGroup.minX + 0.80556 * watchGroup.width, y: watchGroup.minY + 0.55556 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.86111 * watchGroup.width, y: watchGroup.minY + 0.50000 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.83625 * watchGroup.width, y: watchGroup.minY + 0.55556 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.86111 * watchGroup.width, y: watchGroup.minY + 0.53067 * watchGroup.height))
            watchShapePath.addCurve(to: CGPoint(x: watchGroup.minX + 0.80556 * watchGroup.width, y: watchGroup.minY + 0.44444 * watchGroup.height), controlPoint1: CGPoint(x: watchGroup.minX + 0.86111 * watchGroup.width, y: watchGroup.minY + 0.46933 * watchGroup.height), controlPoint2: CGPoint(x: watchGroup.minX + 0.83625 * watchGroup.width, y: watchGroup.minY + 0.44444 * watchGroup.height))
            watchShapePath.close()
            blueish.setFill()
            watchShapePath.fill()
        }
    ...
    @objc dynamic public class func drawCircleShape(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 300, height: 300), resizing: ResizingBehavior = .aspectFit, angle: CGFloat = 397) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Image Declarations
        let f = UIImage(named: "f.png")!

        //// CircleBezier Drawing
        let circleBezierRect = CGRect(x: 10, y: 10, width: 280, height: 280)
        let circleBezierPath = UIBezierPath()
        circleBezierPath.addArc(withCenter: CGPoint(x: circleBezierRect.midX, y: circleBezierRect.midY), radius: circleBezierRect.width / 2, startAngle: -360 * CGFloat.pi/180, endAngle: -angle * CGFloat.pi/180, clockwise: true)
        circleBezierPath.addLine(to: CGPoint(x: circleBezierRect.midX, y: circleBezierRect.midY))
        circleBezierPath.close()

        context.saveGState()
        circleBezierPath.addClip()
        context.scaleBy(x: 1, y: -1)
        context.draw(f.cgImage!, in: CGRect(x: 10, y: -10, width: f.size.width, height: f.size.height), byTiling: true)
        context.restoreGState()
